...
function MostPopularCourses() {
  const services = [
    ...
    // إضافة خدمات جديدة
    {
      ...
      description:
        "حلول متكاملة لإدارة الموارد البشرية، من التوظيف إلى تطوير الموظفين",
      icon: "fas fa-users", // أيقونة الموارد البشرية
      link: "/Human-Resources", // الرابط للصفحة الخاصة بهذه الخدمة
    },
    {
      id: 5,
      title: "الاداره العامه",
      description:
        "تخطيط وتنفيذ وإدارة المشاريع بكفاءة عالية لتحقيق الأهداف المرجوة",
      icon: "fas fa-tasks", // أيقونة إدارة المشاريع
      link: "/Professional-Certificates", // الرابط للصفحة الخاصة بهذه الخدمة
    },
    {
      id: 6,
      title: "الصحة والسلامة المهنية",
      description: "ضمان بيئة عمل آمنة وصحية لحماية الموظفين وتقليل المخاطر",
      icon: "fas fa-shield-alt", // أيقونة الصحة والسلامة
      link: "/Health-Certificates", // الرابط للصفحة الخاصة بهذه الخدمة
    },
  ];
